...
xst -ifn xst.scr
move pll4x_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll4x_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll4x_exdes.ucf pll4x_exdes

echo 'Running map'
map -timing -pr b pll4x_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll4x_exdes -w routed.ncd routed.v
cd ..
